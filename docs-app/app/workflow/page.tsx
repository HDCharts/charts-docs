            ...
            <div className="workflow-lane">
              ...
              <div className="workflow-branch-grid">
                ...
                <WorkflowBranch label="YES" tone="success">
                  <WorkflowNode label="ANDROID EMULATOR" title="Record and compare GIF baselines" detail={<>The job stays outside the required core gate, but its report and generated GIFs are uploaded for review. See the <Link href={`/${defaultVersion}/wiki`}>chart docs</Link>.</>} tone="success" />
                  <div className="workflow-branch-grid">
